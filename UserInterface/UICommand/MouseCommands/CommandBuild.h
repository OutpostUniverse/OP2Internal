...
namespace OP2ForcedExport
{
	...
	public:
		...
		virtual int GetBuildCursor(int startPixelX, int startPixelY, int endPixelX, int endPixelY, HCURSOR* mouseCursor, int highLight[], Unit* constructionVehicle);	// 0x451DC0
